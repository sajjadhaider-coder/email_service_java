...
@Entity
public class CinqdEmail implements java.io.Serializable {
	...
	public CinqdEmail(Integer messageId,  Integer businessId, Timestamp created, String sender, String recipient, String cc,
